...
class ReflectionFactoryTest extends PHPUnit_Framework_TestCase
{
	...
	{
		$tokenReflectionClassMock = Mockery::mock('TokenReflection\IReflectionClass', 'ApiGen\SmartObject');
	...
	{
		$tokenReflectionFunctionMock = Mockery::mock('TokenReflection\IReflectionFunction', 'ApiGen\SmartObject');
	...
	{
		$tokenReflectionMethodMock = Mockery::mock('TokenReflection\IReflectionMethod', 'ApiGen\SmartObject');
	...
	{
		$tokenReflectionPropertyMock = Mockery::mock('TokenReflection\IReflectionProperty', 'ApiGen\SmartObject');
	...
	{
		$tokenReflectionParameterMock = Mockery::mock('TokenReflection\IReflectionParameter', 'ApiGen\SmartObject');
	...
	{
		$tokenReflectionConstantMock = Mockery::mock('TokenReflection\IReflectionConstant', 'ApiGen\SmartObject');
	...
	{
		$tokenReflectionExtensionMock = Mockery::mock('TokenReflection\IReflectionExtension', 'ApiGen\SmartObject');
