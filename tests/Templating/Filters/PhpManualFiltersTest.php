...
class PhpManualFiltersTest extends PHPUnit_Framework_TestCase
{
	...
	{
		$reflectionMock = Mockery::mock('TokenReflection\IReflectionExtension', 'ApiGen\SmartObject');
	...
	public function testManualUrlForMethod()
	{
		...
		$reflectionMock = Mockery::mock('TokenReflection\IReflectionMethod', 'ApiGen\SmartObject');
	...
	public function testManualUrlForFunction()
	{
		...
		$reflectionMock = Mockery::mock('TokenReflection\IReflectionFunction', 'ApiGen\SmartObject');
	...
	public function testManualUrlForConstant()
	{
		...
		$reflectionMock = Mockery::mock('TokenReflection\IReflectionConstant', 'ApiGen\SmartObject');
